import { Camera, ArrowRight, Shield, Utensils, TreePine } from "lucide-react"
    ...
    <section className="py-16 bg-blue-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">{t("facilityTour.subtitle")}</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4">{t(`facilityTour.areas.${area.key}.description`)}</p>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-2">{t("facilityTour.safety.title")}</h3>
            <p className="text-gray-600">{t("facilityTour.safety.subtitle")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {["security", "hygiene", "emergency", "supervision"].map((feature, index) => (
              <div key={feature} className="text-center">
                ...
                <p className="text-sm text-gray-600">{t(`facilityTour.safety.features.${feature}.description`)}</p>
              </div>
            ))}
          </div>
        </div>
